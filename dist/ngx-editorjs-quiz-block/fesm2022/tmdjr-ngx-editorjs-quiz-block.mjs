...
class NgxEditorjsQuizBlockService {
    constructor() { }
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: NgxEditorjsQuizBlockService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: NgxEditorjsQuizBlockService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: NgxEditorjsQuizBlockService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
class NgxEditorjsQuizBlockMediator {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: NgxEditorjsQuizBlockMediator, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: NgxEditorjsQuizBlockMediator, isStandalone: true, selector: "ngx-editorjs-quiz-paragraph-block", inputs: { blockId: "blockId", form: "form", formControlName: "formControlName" }, ngImport: i0, template: `
    <div [formGroup]="form">
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: NgxEditorjsQuizBlockMediator, decorators: [{
            type: Component,
            args: [{
                    standalone: true,
