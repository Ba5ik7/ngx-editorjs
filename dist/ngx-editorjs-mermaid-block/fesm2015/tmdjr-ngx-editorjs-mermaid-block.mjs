...
class NgxEditorjsMermaidClientBlockComponent {
    ...
    set value(mermaidDiagram) {
        ...
        this.ngZone.runOutsideAngular(() => {
            this._mermaidAPI.render(uniqueId, mermaidDiagram !== null && mermaidDiagram !== void 0 ? mermaidDiagram : '').then(data => this.ngZone.run(() => this._mermaidDiagramSVG = data.svg), error => console.warn(`Error: ${error}`));
        });
    }
    ngOnInit() {
        this.ngZone.runOutsideAngular(() => {
    ...
    set savedAction(action) {
        ...
        this.activeMermaidClass = action !== null && action !== void 0 ? action : 'flex-start';
    }
}
...
NgxEditorjsMermaidClientBlockComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: NgxEditorjsMermaidClientBlockComponent, selectors: [["ngx-editorjs-mermaid-client-block"]], inputs: { value: "value", savedAction: "savedAction" }, standalone: true, features: [i0.ɵɵStandaloneFeature], decls: 4, vars: 4, consts: [[1, "mermaid-container"], [1, "mermaid", 3, "ngClass", "innerHTML"], ["mermaidContainer", ""]], template: function NgxEditorjsMermaidClientBlockComponent_Template(rf, ctx) {
    ...
    }, dependencies: [CommonModule, i1$1.NgClass, SafeHtmlPipe], styles: ["[_nghost-%COMP%]{display:flex;flex-direction:column;position:relative;padding-bottom:22px}.mermaid[_ngcontent-%COMP%]{width:100%;display:flex}.mermaid-container[_ngcontent-%COMP%]{display:flex}[_nghost-%COMP%]   .flex-start[_ngcontent-%COMP%]{justify-content:flex-start}[_nghost-%COMP%]   .flex-end[_ngcontent-%COMP%]{justify-content:flex-end}[_nghost-%COMP%]   .center[_ngcontent-%COMP%]{justify-content:center}"] });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgxEditorjsMermaidClientBlockComponent, [{
            type: Component,
...
NgxEditorjsMermaidBlockComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: NgxEditorjsMermaidBlockComponent, selectors: [["ngx-editorjs-mermaid-block"]], viewQuery: function NgxEditorjsMermaidBlockComponent_Query(rf, ctx) {
    ...
    }, dependencies: [CommonModule, i1$1.NgClass, i1$1.NgIf, MatLegacyButtonModule, i3.MatLegacyButton, MatIconModule, i3$1.MatIcon, MermaidConfigComponent,
...
NgxEditorjsMermaidBlockMediator.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: NgxEditorjsMermaidBlockMediator, selectors: [["ngx-editorjs-mermaid-blockquotes-block"]], inputs: { blockId: "blockId", form: "form", formControlName: "formControlName", savedAction: "savedAction" }, standalone: true, features: [i0.ɵɵStandaloneFeature], decls: 2, vars: 4, consts: [[3, "formGroup"], [3, "blockId", "formControlName", "savedAction"]], template: function NgxEditorjsMermaidBlockMediator_Template(rf, ctx) {
    ...
    }, dependencies: [ReactiveFormsModule, i1$3.NgControlStatus, i1$3.NgControlStatusGroup, i1$3.FormGroupDirective, i1$3.FormControlName, NgxEditorjsMermaidBlockComponent], encapsulation: 2 });
(function () {
