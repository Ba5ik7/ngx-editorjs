...
class SafeHtmlPipe {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.13", ngImport: i0, type: SafeHtmlPipe, deps: [{ token: i1.DomSanitizer }], target: i0.ɵɵFactoryTarget.Pipe }); }
...
class NgxEditorjsMermaidBlockService {
    constructor() { }
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.13", ngImport: i0, type: NgxEditorjsMermaidBlockService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "18.2.13", ngImport: i0, type: NgxEditorjsMermaidBlockService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.13", ngImport: i0, type: NgxEditorjsMermaidBlockService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
class NgxEditorjsMermaidBlockMediator {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.13", ngImport: i0, type: NgxEditorjsMermaidBlockMediator, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "18.2.13", type: NgxEditorjsMermaidBlockMediator, isStandalone: true, selector: "ngx-editorjs-mermaid-blockquotes-block", inputs: { blockId: "blockId", form: "form", formControlName: "formControlName", savedAction: "savedAction" }, ngImport: i0, template: `
    <div [formGroup]="form">
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.13", ngImport: i0, type: NgxEditorjsMermaidBlockMediator, decorators: [{
            type: Component,
            args: [{
                    standalone: true,
