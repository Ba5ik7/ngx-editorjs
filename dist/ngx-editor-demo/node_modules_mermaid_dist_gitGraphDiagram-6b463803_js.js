"use strict";
(self["webpackChunkngx_editor_demo"] = self["webpackChunkngx_editor_demo"] || []).push([["node_modules_mermaid_dist_gitGraphDiagram-6b463803_js"],{
      ...
      if (commit2.tag) {
        ...
        if (dir === "TB") {
          rect.attr("class", "tag-label-bkg").attr("points", `
            ...
            ${x + 10 + tagBbox.width + px},${pos + h2 + py}
            ${x + 10},${pos + h2 + py}`).attr("transform", "translate(12,12) rotate(45, " + x + "," + pos + ")");
...
const draw = function (txt, id, ver, diagObj) {
  ...
  (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_5__.y)(void 0, diagram2, gitGraphConfig.diagramPadding, gitGraphConfig.useMaxWidth ?? conf.useMaxWidth);
};
...
//# sourceMappingURL=node_modules_mermaid_dist_gitGraphDiagram-6b463803_js.js.map