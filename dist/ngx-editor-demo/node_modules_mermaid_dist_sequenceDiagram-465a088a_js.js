"use strict";
(self["webpackChunkngx_editor_demo"] = self["webpackChunkngx_editor_demo"] || []).push([["node_modules_mermaid_dist_sequenceDiagram-465a088a_js"],{
...
const drawMessage = function (diagram2, msgModel, lineStartY, diagObj) {
  ...
  if (startx === stopx) {
    if (conf.rightAngles) {
      line = diagram2.append("path").attr("d", `M  ${startx},${lineStartY} H ${startx + _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_5__.e.getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`);
    } else {
...
const draw = function (_text, id, _version, diagObj) {
  const {
    securityLevel,
    sequence
  } = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_5__.c)();
  conf = sequence;
  let sandboxElement;
...
const buildNoteModel = function (msg, actors2, diagObj) {
  ...
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_5__.l.debug(`NM:[${noteModel.startx},${noteModel.stopx},${noteModel.starty},${noteModel.stopy}:${noteModel.width},${noteModel.height}=${msg.message}]`);
  return noteModel;
};
...
//# sourceMappingURL=node_modules_mermaid_dist_sequenceDiagram-465a088a_js.js.map