"use strict";
(self["webpackChunkngx_editor_demo"] = self["webpackChunkngx_editor_demo"] || []).push([["default-node_modules_mermaid_dist_index-5219d011_js"],{
...
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash-es */ 27746);
...
/***/ 26625:
/*!*****************************************************!*\
  !*** ./node_modules/mermaid/dist/index-5219d011.js ***!
  \*****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dagre-d3-es/src/dagre/index.js */ 57130);
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dagre-d3-es/src/graphlib/json.js */ 37995);
/* harmony import */ var _edges_2e77835f_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./edges-2e77835f.js */ 64409);
/* harmony import */ var _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./commonDb-573409be.js */ 91090);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! dagre-d3-es/src/graphlib/index.js */ 69402);
/* harmony import */ var _createText_1f5f8f92_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./createText-1f5f8f92.js */ 16463);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! d3 */ 17659);
...
const copy = (clusterId, graph, newGraph, rootId) => {
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Copying children of ", clusterId, "root", rootId, "data", graph.node(clusterId), rootId);
  ...
  nodes.forEach(node => {
    if (graph.children(node).length > 0) {
      ...
      if (clusterId !== rootId && node !== clusterId) {
        ...
        _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Not Setting parent for node=", node, "cluster!==rootId", clusterId !== rootId, "node!==clusterId", node !== clusterId);
      }
      ...
      edges.forEach(edge => {
        ...
        try {
          if (edgeInCluster(edge, rootId)) {
            ...
            _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Skipping copy of edge ", edge.v, "-->", edge.w, " rootId: ", rootId, " clusterId:", clusterId);
          }
        } catch (e) {
...
const adjustClustersAndEdges = (graph, depth) => {
  ...
  graph.nodes().forEach(function (id) {
    ...
    if (children.length > 0) {
      _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Cluster identified", id, " Replacement id in edges: ", findNonClusterChild(id, graph));
  ...
  graph.edges().forEach(function (e) {
    ...
    let v = e.v;
    let w = e.w;
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Fix XXX", clusterDb, "ids:", e.v, e.w, "Translating: ", clusterDb[e.v], " --- ", clusterDb[e.w]);
  ...
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph));
  extractor(graph, 0);
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.trace(clusterDb);
};
const extractor = (graph, depth) => {
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph), graph.children("D"));
  if (depth > 10) {
  ...
  for (const node of nodes) {
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Extracting node", node, clusterDb, clusterDb[node] && !clusterDb[node].externalConnections, !graph.parent(node), graph.node(node), graph.children("D"), " Depth ", depth);
    if (!clusterDb[node]) {
    ...
    graph.children(node) && graph.children(node).length > 0) {
      _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Cluster without external connections, without a parent and with children", node, depth);
      ...
      _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph));
      ...
      _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(clusterGraph));
      _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph));
    } else {
      _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Cluster ** ", node, " **not meeting the criteria !externalConnections:", !clusterDb[node].externalConnections, " no parent: ", !graph.parent(node), " children ", graph.children(node) && graph.children(node).length > 0, graph.children("D"), depth);
...
const rect = (parent, node) => {
  ...
  const text = node.labelType === "markdown" ? (0,_createText_1f5f8f92_js__WEBPACK_IMPORTED_MODULE_5__.c)(label, node.labelText, {
    style: node.labelStyle,
    useHtmlLabels
  }) : label.node().appendChild((0,_edges_2e77835f_js__WEBPACK_IMPORTED_MODULE_6__.c)(node.labelText, node.labelStyle, void 0, true));
...
const roundedWithTitle = (parent, node) => {
  ...
  label.attr("transform", "translate(" + (node.x - bbox.width / 2) + ", " + (node.y - node.height / 2 - node.padding / 3 + ((0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.k)((0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.g)().flowchart.htmlLabels) ? 5 : 3)) + ")");
  const rectBox = rect2.node().getBBox();
  node.height = rectBox.height;
  node.intersect = function (point) {
    return (0,_edges_2e77835f_js__WEBPACK_IMPORTED_MODULE_6__.i)(node, point);
...
const recursiveRender = (_elem, graph, diagramtype, parentCluster) => {
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph), parentCluster);
  ...
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph after layout:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph));
  let diff = 0;
  sortNodesByHierarchy(graph).forEach(function (v) {
    const node = graph.node(v);
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Position " + v + ": " + JSON.stringify(graph.node(v)));
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Position " + v + ": (" + node.x, "," + node.y, ") width: ", node.width, " height: ", node.height);
    if (node && node.clusterNode) {
...
const render = (elem, graph, markers, diagramtype, id) => {
  ...
  clear();
  clear$1();
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph at first:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph));
  adjustClustersAndEdges(graph);
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph after:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph));
...
//# sourceMappingURL=default-node_modules_mermaid_dist_index-5219d011_js.js.map