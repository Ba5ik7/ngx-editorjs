"use strict";
(self["webpackChunkngx_editor_demo"] = self["webpackChunkngx_editor_demo"] || []).push([["node_modules_mermaid_dist_stateDiagram-b620d43f_js"],{

/***/ 32323:
/*!************************************************************!*\
  !*** ./node_modules/mermaid/dist/stateDiagram-b620d43f.js ***!
  \************************************************************/
...
/* harmony export */ });
/* harmony import */ var _styles_bbc3fe3b_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./styles-bbc3fe3b.js */ 63862);
...
/* harmony import */ var _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mermaid-934d9bea.js */ 19415);
...
const drawDescrState = (g, stateDef) => {
  ...
  const description = g.append("text").attr("x", (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.padding).attr("y", titleHeight + (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.padding * 0.4 + (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.dividerMargin + (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.textHeight).attr("class", "state-description");
  let isFirst = true;
  let isSecond = true;
...
const addTitleAndBox = (g, stateDef, altBkg) => {
  ...
  g.insert("rect", ":first-child").attr("x", startX).attr("y", lineY).attr("class", altBkg ? "alt-composit" : "composit").attr("width", width).attr("height", graphBox.height + (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.textHeight + (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.titleShift + 1).attr("rx", "0");
  title.attr("x", startX + pad);
  if (titleWidth <= orgWidth) {
    title.attr("x", orgX + (width - dblPad) / 2 - titleWidth / 2 + pad);
  }
  g.insert("rect", ":first-child").attr("x", startX).attr("y", (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.titleShift - (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.textHeight - (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.padding).attr("width", width).attr("height", (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.textHeight * 3).attr("rx", (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.radius);
  g.insert("rect", ":first-child").attr("x", startX).attr("y", (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.titleShift - (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.textHeight - (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.padding).attr("width", width).attr("height", graphBox.height + 3 + 2 * (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.textHeight).attr("rx", (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.radius);
  return g;
};
const drawEndState = g => {
  g.append("circle").attr("class", "end-state-outer").attr("r", (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.sizeUnit + (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.miniPadding).attr("cx", (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.padding + (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.sizeUnit + (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.miniPadding).attr("cy", (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.padding + (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.sizeUnit + (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.c)().state.miniPadding);
...
const drawEdge = function (elem, path, relation) {
  ...
  svgPath.attr("marker-end", "url(" + url + "#" + getRelationType(_styles_bbc3fe3b_js__WEBPACK_IMPORTED_MODULE_8__.d.relationType.DEPENDENCY) + "End)");
  if (relation.title !== void 0) {
    const label = elem.append("g").attr("class", "stateLabel");
    const {
      x,
      y
    } = _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_7__.u.calcLabelPosition(path.points);
...
//# sourceMappingURL=node_modules_mermaid_dist_stateDiagram-b620d43f_js.js.map