"use strict";
(self["webpackChunkngx_editor_demo"] = self["webpackChunkngx_editor_demo"] || []).push([["default-node_modules_mermaid_dist_edges-2e77835f_js"],{

/***/ 64409:
/*!*****************************************************!*\
  !*** ./node_modules/mermaid/dist/edges-2e77835f.js ***!
  \*****************************************************/
...
/* harmony import */ var _createText_1f5f8f92_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createText-1f5f8f92.js */ 16463);
/* harmony import */ var _mermaidAPI_3ae0f2f0_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mermaidAPI-3ae0f2f0.js */ 12910);
/* harmony import */ var _svgDraw_2526cba0_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./svgDraw-2526cba0.js */ 98352);
...
const createLabel = (_vertexText, style, isTitle, isNode) => {
  ...
  if ((0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_1__.k)((0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_1__.g)().flowchart.htmlLabels)) {
    ...
    const node = {
      isNode,
      label: (0,_mermaidAPI_3ae0f2f0_js__WEBPACK_IMPORTED_MODULE_2__.d)(vertexText).replace(/fa[blrs]?:fa-[\w-]+/g, s => `<i class='${s.replace(":", " ")}'></i>`),
...
const labelHelper = (parent, node, _classes, isNode) => {
  ...
  if (node.labelType === "markdown") {
    ...
    text = textNode.appendChild(createLabel$1((0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_1__.b)((0,_mermaidAPI_3ae0f2f0_js__WEBPACK_IMPORTED_MODULE_2__.d)(labelText), (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_1__.g)()), node.labelStyle, false, isNode));
  }
...
const note = (parent, node) => {
  ...
  const {
    ...
    bbox,
    halfPadding
  } = labelHelper(parent, node, "node " + node.classes, true);
...
const question = (parent, node) => {
  const {
    shapeSvg,
    bbox
  } = labelHelper(parent, node, void 0, true);
...
const labelRect = (parent, node) => {
  const {
    shapeSvg
  } = labelHelper(parent, node, "label", true);
...
const class_box = (parent, node) => {
  ...
  if (hasInterface) {
    ...
    (0,d3__WEBPACK_IMPORTED_MODULE_0__.select)(interfaceLabel).attr("transform", "translate( " + (-1 * maxWidth / 2 + diffX2) + ", " + -1 * maxHeight / 2 + ")");
...
const positionNode = node => {
  ...
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_1__.l.trace("Transforming node", node.diff, node, "translate(" + (node.x - node.width / 2 - 5) + ", " + node.width / 2 + ")");
  const padding = 8;
...
const positionEdgeLabel = (edge, paths) => {
  ...
  if (edge.label) {
    ...
    if (path) {
      ...
      _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Moving label " + edge.label + " from (", x, ",", y, ") to (", pos.x, ",", pos.y, ") abc78");
  ...
  if (edge.startLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _utils_d622194a_js__WEBPACK_IMPORTED_MODULE_5__.u.calcTerminalLabelPosition(edge.arrowTypeStart ? 10 : 0, "start_right", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", "translate(" + x + ", " + y + ")");
...
const intersection = (node, outsidePoint, insidePoint) => {
  ...
  if (Math.abs(y - outsidePoint.y) * w > Math.abs(x - outsidePoint.x) * h) {
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_1__.l.warn(`sides calc abc89, Q ${Q}, q ${q}, R ${R}, r ${r}`, {
      _x,
      _y
    });
    if (r === 0) {
...
const insertEdge = function (elem, e, edge, clusterDb, diagramType, graph) {
  ...
  if (head.intersect && tail.intersect) {
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Last point", points[points.length - 1], head, head.intersect(points[points.length - 1]));
...
//# sourceMappingURL=default-node_modules_mermaid_dist_edges-2e77835f_js.js.map