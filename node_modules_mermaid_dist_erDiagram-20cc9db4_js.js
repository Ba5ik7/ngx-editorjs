"use strict";
(self["webpackChunkngx_editor_demo"] = self["webpackChunkngx_editor_demo"] || []).push([["node_modules_mermaid_dist_erDiagram-20cc9db4_js"],{
...
/* harmony export */ });
/* harmony import */ var _validate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validate.js */ 54669);
...
/* harmony export */ });
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stringify.js */ 94880);
/* harmony import */ var _parse_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parse.js */ 46886);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _v35_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./v35.js */ 3509);
/* harmony import */ var _sha1_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sha1.js */ 98538);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _regex_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./regex.js */ 68792);
...
/***/ 78913:
/*!*********************************************************!*\
  !*** ./node_modules/mermaid/dist/erDiagram-20cc9db4.js ***!
  \*********************************************************/
...
/* harmony export */ });
/* harmony import */ var _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./commonDb-573409be.js */ 91090);
/* harmony import */ var _mermaidAPI_3ae0f2f0_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mermaidAPI-3ae0f2f0.js */ 12910);
...
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! dagre-d3-es/src/dagre/index.js */ 57130);
/* harmony import */ var _utils_d622194a_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils-d622194a.js */ 71991);
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! uuid */ 61426);
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! dompurify */ 58120);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! dayjs */ 16901);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @braintree/sanitize-url */ 35962);
...
const addEntity = function (name) {
  if (entities[name] === void 0) {
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Added new entity :", name);
  }
...
const addAttributes = function (entityName, attribs) {
  ...
  for (i = attribs.length - 1; i >= 0; i--) {
    ...
    _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Added attribute ", attribs[i].attributeName);
  }
};
const addRelationship = function (entA, rolA, entB, rSpec) {
  ...
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Added new relationship :", rel);
};
...
const erDb = {
  ...
  Identification,
  parseDirective,
  getConfig: () => (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.g)().er,
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
  ...
  setDiagramTitle: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.w,
  getDiagramTitle: _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.x
};
const ERMarkers = {
...
const drawAttributes = (groupNode, entityTextNode, attributes) => {
  ...
  attributes.forEach(item => {
    ...
    let nodeHeight = 0;
    const attributeType = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.z)(item.attributeType);
    const typeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", attrFontSize + "px").text(attributeType);
    const nameNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeName);
    const attributeNode = {};
    ...
    if (hasKeyType) {
      ...
      const keyTypeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", attrFontSize + "px").text(keyTypeNodeText);
    ...
    if (hasComment) {
      const commentNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-comment`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeComment || "");
...
const drawEntities = function (svgNode, entities2, graph) {
  ...
  keys.forEach(function (entityName) {
    ...
    const textNode = groupNode.append("text").classed("er entityLabel", true).attr("id", textId).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", conf.fontSize + "px").text(entityName);
    const {
      width: entityWidth,
      height: entityHeight
...
const drawRelationshipFromLayout = function (svg, rel, g, insert, diagObj) {
  ...
  const labelNode = svg.append("text").classed("er relationshipLabel", true).attr("id", labelId).attr("x", labelPoint.x).attr("y", labelPoint.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.g)().fontFamily).style("font-size", conf.fontSize + "px").text(rel.roleA);
...
const draw = function (text, id, _version, diagObj) {
  conf = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.g)().er;
  _commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing ER diagram");
  const securityLevel = (0,_commonDb_573409be_js__WEBPACK_IMPORTED_MODULE_7__.g)().securityLevel;
  let sandboxElement;
  ...
  _utils_d622194a_js__WEBPACK_IMPORTED_MODULE_8__.u.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
...
function generateId(str = "", prefix = "") {
  ...
  return `${strWithHyphen(prefix)}${strWithHyphen(simplifiedStr)}${(0,uuid__WEBPACK_IMPORTED_MODULE_9__["default"])(str, MERMAID_ERDIAGRAM_UUID)}`;
}
...
//# sourceMappingURL=node_modules_mermaid_dist_erDiagram-20cc9db4_js.js.map